#include <Include/ObjectUnique.h>
#include <iostream>
...
vector<MuonHLT::HLTObject> GetAllHLTObject(unique_ptr<NtupleHandle> &ntuple, TString filterName = "", Double_t minPt = -1)
{
...
vector<MuonHLT::MYHLTObject> GetAllMYHLTObject(unique_ptr<NtupleHandle> &ntuple, TString filterName = "", Double_t minPt = -1)
{
...
vector<MuonHLT::L1Muon> GetAllL1Muon(unique_ptr<NtupleHandle> &ntuple, Double_t minPt = -1 )
{
...
vector<MuonHLT::L2Muon> GetAllL2Muon(unique_ptr<NtupleHandle> &ntuple, Double_t minPt = -1 )
{
...
Bool_t dRMatching_L1Muon( TLorentzVector vecP_ref, unique_ptr<NtupleHandle> &ntuple, Double_t minPt, Double_t minDR )
{
...
Bool_t dRMatching_HLTObj( TLorentzVector vecP_ref, unique_ptr<NtupleHandle> &ntuple, TString filterName, Double_t minDR )
{
...
Bool_t dRMatching_MYHLTObj( TLorentzVector vecP_ref, unique_ptr<NtupleHandle> &ntuple, TString filterName, Double_t minDR )
{
